        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#organisations">Blog</a></li>
                    <li><a href="#contact">Contact</a></li>

                    <li><a href="Login.aspx">Sign in</a></li>
                    <li class="btn-trial"><a href="Register.aspx">Free Trial</a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="row">
                    <div class="banner-text text-center">
                        ...
                        <div class="intro-para text-center quote">
                            ...
                            <p class="small-text">  Boost your productivity and cut losses with the leading Equipment Tracking Software.</p>
                            <a href="Register.aspx" class="btn get-quote">Start Free Trial</a>
                            <p class="small-text">15 days trial. No Credit Card Required.</p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="feature-info">
                    <div class="fea">
                        <div class="col-md-4">
                            <div class="heading pull-right">
                                <h4>Track the complete Asset Life Cycle</h4>
                                <p>A complete asset management solution that comes with a comprehensive log for each asset - starting from procurement all the way through to retirement.</p>
                            </div>
                    ...
                    <div class="fea">
                        <div class="col-md-4">
                            <div class="heading pull-right">
                                <h4>Simplify operations that involve equipment</h4>
                                <p> Improve equipment inventory management by simplifying your workflow. Know what’s needed, by whom, and when it’s due back.</p>
                            </div>
                            <div class="fea-img pull-left">
                    ...
                    <div class="fea">
                        <div class="col-md-4">
                            <div class="heading pull-right">
                                <h4>Tag your items with RFID, QR Codes and Barcodes</h4>
                                <p> Use external RFID readers to scan items and take actions on them using our app. You can also design and print professional QR Codes and Barcodes, and scan them with our app.</p>
                            </div>
                            <div class="fea-img pull-left">
                ...
                <div class="feature-info">
                    <div class="fea">
                        <div class="col-md-4">
                            <div class="heading pull-right">
                                <h4>Empower everyone at your organizations</h4>
                                <p>  Asset inventory software “approach(ing) Asset Management untraditionally through a delegation model, in which the responsibility of inventory tracking is shared”.</p>
                            </div>
                            <div class="fea-img pull-left">
                                <i class="fa fa-css3"></i>
                            </div>
